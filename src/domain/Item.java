...
public class Item {
	...
	public String toString() {
		return "ClassPojo [affiliateAddToCartUrl = " + affiliateAddToCartUrl + ", standardShipRate = "
				+ standardShipRate + ", customerRatingImage = " + customerRatingImage + ", thumbnailImage = "
				+ thumbnailImage + ", giftOptions = " + giftOptions + ", productTrackingUrl = " + productTrackingUrl
				+ ", msrp = " + msrp + ", categoryNode = " + categoryNode + ", numReviews = " + numReviews
				+ ", mediumImage = " + mediumImage + ", name = " + name + ", longDescription = " + longDescription
				+ ", bundle = " + bundle + ", addToCartUrl = " + addToCartUrl + ", imageEntities = " + imageEntities
				+ ", marketplace = " + marketplace + ", customerRating = " + customerRating + ", largeImage = "
				+ largeImage + ", parentItemId = " + parentItemId + ", itemId = " + itemId + ", upc = " + upc
				+ ", categoryPath = " + categoryPath + ", availableOnline = " + availableOnline
				+ ", shortDescription = " + shortDescription + ", productUrl = " + productUrl + ", salePrice = "
				+ salePrice + ", modelNumber = " + modelNumber + "]";
	}
